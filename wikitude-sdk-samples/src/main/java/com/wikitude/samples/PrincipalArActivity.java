...
import com.example.guiar.AddSiteFragment;
import com.example.guiar.ExploreFragment;
import com.example.guiar.FavoriteFragment;
import com.example.guiar.MyLocationFragment;
import com.example.guiar.OurGroupFragment;
 ...
 */
public class PrincipalArActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    public static final String INTENT_EXTRAS_KEY_SAMPLE = "sampleData";

    private static final String TAG = PrincipalArActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frameLayout.addView(architectView);

        //Toolbar in the top of the screen
    ...
    public boolean onNavigationItemSelected( MenuItem item) {
        ...
        if (id == R.id.nav_explore){
            fragmentManager.beginTransaction().replace(R.id.linear_layout,new ExploreFragment()).commit();
        } else if (id == R.id.nav_favorites) {
            fragmentManager.beginTransaction().replace(R.id.linear_layout,new FavoriteFragment()).commit();
        } else if (id == R.id.nav_my_location) {
            fragmentManager.beginTransaction().replace(R.id.linear_layout,new MyLocationFragment()).commit();
        } else if (id == R.id.nav_add_site) {
            fragmentManager.beginTransaction().replace(R.id.linear_layout,new AddSiteFragment()).commit();
        } else if (id == R.id.nav_our_group) {
            fragmentManager.beginTransaction().replace(R.id.linear_layout,new OurGroupFragment()).commit();
        }
